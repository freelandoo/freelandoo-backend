...
const tourSettingsAdminRoutes = require("./tourSettingsAdmin.routes");
...
module.exports = (app) => {
  ...
  app.use("/users/me/features", userFeaturePrefRoutes);
  app.use("/users/me/quick-pills", userQuickPillsRoutes);
